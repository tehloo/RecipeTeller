 ...
 */
class ConfigLoaderHTWD {
    private static final String TAG = ConfigLoaderHTWD.class.getSimpleName();
     ...
     */
    ConfigLoaderHTWD(Context context) {
        mContext = context;
     ...
     * @param context Context
     */
    ConfigLoaderHTWD(Context context, String assetFileName) {
        mContext = context;
    ...
    void putExternalPath(String path) {
        mPref.edit().putString(ConfigLoaderHTWD.KEY_EXTERNAL_PATH, path).apply();
    }
